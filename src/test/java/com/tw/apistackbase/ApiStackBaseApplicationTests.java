...
//	}
	@Test
	public void shouldPuttset() throws Exception {
		this.mockMvc.perform(get("/companies?page=0&pageSize=1")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString("1 one.2 two.")));
